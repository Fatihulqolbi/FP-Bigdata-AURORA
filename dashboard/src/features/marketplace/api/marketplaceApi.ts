...
export const driver = {
  ...
  getAvailableTrucks: () => request<any>("/fleet/driver/available-trucks"),
  claimTruck: (truckId?: string) => request<any>("/fleet/driver/claim", { method: "POST", body: JSON.stringify(truckId ? { truckId } : {}) }),
  releaseTruck: () => request<any>("/fleet/driver/release", { method: "POST" }),
